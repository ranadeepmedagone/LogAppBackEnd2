...
using Logappback.Repositories;
using Logappback.Utilities;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
namespace Logappback.Controllers;
[ApiController]
[Route("api/log")]
[Authorize]
public class LogController : ControllerBase
{
  ...
  public async Task<ActionResult<Log>> CreateLog([FromBody] LogCreateDTO data)
  {
    ...
    if (createdLog is not null)
    {
      ...
      _email.Send("ranadeepmedagone@gmail.com", "You got new log", $"<p>{data.Title}</p>", "ranadeepmedagone@gmail.com");
    }
