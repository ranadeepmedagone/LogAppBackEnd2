using Dapper;
using Hangfire;
using Logappback.DTOs;
using Logappback.Models;
using Logappback.Services;
using Logappback.Utilities;

namespace Logappback.Repositories;
...
public interface ILogRepository
{
    ...
    Task<List<Log>> AllLogsForUser(long userId);
}
public class LogRepository : BaseRepository, ILogRepository
{
    ...
    public async Task<List<Log>> AllLogsForUser(long userId)
    {
        ...
        using (var con = NewConnection)
            return (await con.QueryAsync<Log>(query, new { UserId = userId })).AsList();
    }
